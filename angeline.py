...
book_dict_tup = {
    ...
    ("stop",): "STOP",
    # Books
    ("gn", "gen", "gene", "gens", "genesis"): "Genesis",
    ("ex", "exo", "exod", "exodus"): "Exodus",
    ("lv", "lev", "levi", "leviticus"): "Leviticus",
    ("nu", "num", "numb", "1 nums","numbers"): "Numbers",
    ("dt", "deu", "deut", "deuteronomy"): "Deuteronomy",
    ("js", "jos", "josh", "joshua"): "Joshua",
    ("jd", "jdg", "judg", "judges"): "Judges",
    ("rt", "rut", "ruth"): "Ruth",
    ("1 sa", "1 sam", "1 samu", "1 same","1 samuel"): "1 Samuel",
    ("2 sa", "2 sam", "1 samu", "1 same","2 samuel"): "2 Samuel",
    ("1 ki", "1 kin", "1 king", "1 kings"): "1 Kings",
    ("2 ki", "2 kin", "2 king", "2 kings"): "2 Kings",
    ("1 ch", "1 chr", "1 chro", "1 chrn","1 chronicles"): "1 Chronicles",
    ("2 ch", "2 chr", "2 chro", "1 chrn","2 chronicles"): "2 Chronicles",
    ("er", "ezr", "ezra"): "Ezra",
    ("nh", "neh", "nehe", "nehemiah"): "Nehemiah",
    ("et", "est", "esth", "esther"): "Esther",
    ("jb", "job"): "Job",
    ("ps", "psa", "psal", "psalm", "psalms"): "Psalm",
    ("pr", "pro", "prov", "proverbs"): "Proverbs",
    ("ec", "ecc", "eccs", "ecclesiastes"): "Ecclesiastes",
    ("sn", "son", "song", "song of songs", "song of solomon"): "Song of Solomon",
    ("is", "isa", "isai", "isaiah"): "Isaiah",
    ("jr", "jer", "jere", "jeremiah"): "Jeremiah",
    ("lm", "lam", "lame", "lamentations"): "Lamentations",
    ("ez", "eze", "ezek", "ezekiel"): "Ezekiel",
    ("dn", "dan", "dani", "daniel"): "Daniel",
    ("hs", "hos", "hose", "hosea"): "Hosea",
    ("jl", "joe", "joel"): "Joel",
    ("am", "amo", "amos"): "Amos",
    ("ob", "oba", "obad", "obadiah"): "Obadiah",
    ("jo", "jon", "jona", "jonah"): "Jonah",
    ("mi", "mic", "mica", "micah"): "Micah",
    ("na", "nah", "nahu", "nahum"): "Nahum",
    ("hb", "hab", "haba", "habakkuk"): "Habakkuk",
    ("zp", "zep", "zepe", "zephaniah"): "Zephaniah",
    ("hg", "hag", "hagg", "haggai"): "Haggai",
    ("zc", "zec", "zech", "zechariah"): "Zechariah",
    ("ml", "mal", "mala", "malachi"): "Malachi",
    ("mt", "mat", "matt", "matthew"): "Matthew",
    ("mr", "mar", "mark"): "Mark",
    ("lk", "luk", "luke"): "Luke",
    ("jn", "jhn", "john"): "John",
    ("ac", "act", "acts"): "Acts",
    ("rm", "rom", "roms", "romans"): "Romans",
    ("1 co", "1 cor", "1 cori", "1 corinthians"): "1 Corinthians",
    ("2 co", "2 cor", "2 cori", "2 corinthians"): "2 Corinthians",
    ("gl", "gal", "gala", "galatians"): "Galatians",
    ("ep", "eph", "ephe", "ephesians"): "Ephesians",
    ("ph", "phi", "phil", "philippians"): "Philippians",
    ("cl", "col", "colo", "colossians"): "Colossians",
    ("1 th", "1 ths", "1 thes", "1 thessalonians"): "1 Thessalonians",
    ("2 th", "2 ths", "2 thes", "2 thessalonians"): "2 Thessalonians",
    ("1 ti", "1 tim", "1 timo", "1 timothy"): "1 Timothy",
    ("2 ti", "2 tim", "2 timo", "2 timothy"): "2 Timothy",
    ("ti", "tit", "titu", "titus"): "Titus",
    ("pm", "phm", "phmn", "philemon"): "Philemon",
    ("he", "heb", "hebr", "hebrews"): "Hebrews",
    ...
    ("jd", "jud", "jude"): "Jude",
    ("rv", "rev", "reve", "revelation"): "Revelation"
}
